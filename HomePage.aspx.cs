...
public partial class Home_Page : System.Web.UI.Page
{
    ...
    protected async void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            htmlOutput.Append("<h2>\u05d4\u05de\u05dc\u05e6\u05d5\u05ea \u05e2\u05dc \u05e1\u05e8\u05d8\u05d9\u05dd \u05dc\u05e4\u05d9 \u05de\u05e6\u05d1 \u05d4\u05e8\u05d5\u05d7 \u05e9\u05dc\u05da:</h2><div class='recommendations-row'>");
                ...
                htmlOutput.AppendFormat(@"
                    <div class='movie-card'>
                        ...
                        <div class='card-body'>
                            ...
                            <p class='card-text'>\u2b50 \u05d3\u05d9\u05e8\u05d5\u05d2: {2} / 10</p>
    ...
    private async Task<string> GetMovieRecommendations(string mood)
    {
        ...
        string prompt = "תן לי רשימה של בדיוק 4 סרטים שמופיעים באתר TMDB בכל שפה שמתאימים למצב הרוח הבא: \"" + mood + "\". עבור כל סרט תן רק את שם הסרט בלי תקציר.";
    ...
    private async Task<MovieInfo> GetMovieInfo(string title)
    {
        ...
        using (HttpClient client = new HttpClient())
        {
            string searchUrl = "https://api.themoviedb.org/3/search/movie?api_key=" + tmdbKey + "&query=" + Uri.EscapeDataString(title) + "&language=he";
